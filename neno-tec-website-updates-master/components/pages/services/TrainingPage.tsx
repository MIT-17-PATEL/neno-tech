...
const TrainingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section id="programs" className="pt-6 pb-16 md:pt-10 md:pb-24 px-4 md:px-12 lg:px-24 bg-black">
        <div className="max-w-[1920px] mx-auto">
          <SectionHeader
            label="Programs"
            title="Our Training & Education Services"
            subtitle="Expert-led programs designed to upskill teams and transform organizations. Click any program to explore details."
          />

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {category.children.map((child, idx) => (
              <div id={`program-${child.slug}`} key={child.slug} className="scroll-mt-36">
                <VisualServiceCard
                  title={child.title}
                  ...
                  subItems={
                    child.areas
                      ? child.areas.slice(0, 4).map(a => ({ title: a, href: child.href, slug: child.slug }))
                      : child.capabilities
      ...
      <section className="py-16 md:py-32 px-4 md:px-12 lg:px-24 bg-zinc-950/30">
        <div className="max-w-[1920px] mx-auto">
          <SectionHeader
            label="Why It Works"
            title="Learning That Transfers"
            subtitle="Training delivered by practitioners who have built and shipped the systems they teach."
          />
      ...
      <section className="py-16 md:py-32 px-4 md:px-12 lg:px-24 bg-black">
        <div className="max-w-[1920px] mx-auto">
          <SectionHeader
            ...
            subtitle="From skill gap assessment to measurable learning outcomes."
          />
      ...
      <CTASection
        title="Let's Discuss Training Needs"
        subtitle="Tell us about your team's learning objectives and we'll design a tailored program."
