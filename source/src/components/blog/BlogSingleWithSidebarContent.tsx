...
interface BlogSingleWithSidebarProps {
    blogInfo: PublicBlog;
...
const BlogSingleWithSidebarContent = ({ blogInfo, previousBlog, nextBlog, allBlogs = [] }: BlogSingleWithSidebarProps) => {
                        ...
                        <div className="blog-content col-xl-8 col-lg-7 col-md-12 pr-35 pr-md-15 pl-md-15 pr-xs-15 pl-xs-15">
                            ...
                            >
                                <div className="blog-item-box">
                                    <div className="thumb rounded-4 overflow-hidden mb-4 position-relative" style={{ maxHeight: "500px" }}>
                                        <Image
                                            src={imgSrc}
                                    ...
                                    <div className="info">
                                        ...
                                        <h2 className="text-white fw-bold mb-4" style={{ fontSize: "clamp(24px, 3.5vw, 34px)", lineHeight: 1.3, letterSpacing: "-0.02em" }}>
                                            {title}
                                        </h2>
                                ...
                                <div className="post-pagi-area">
                                    {previousBlog ? (
                                        <div className="post-previous">
                                            <Link href={`/blog-single-with-sidebar/${previousBlog.slug || previousBlog.id}`}>
                                    ...
                                    {nextBlog ? (
                                        <div className="post-next">
                                            <Link href={`/blog-single-with-sidebar/${nextBlog.slug || nextBlog.id}`}>
                        ...
                        <div className="sidebar col-xl-4 col-lg-5 col-md-12 mt-md-50 mt-xs-50">
                            <aside>
                                <div className="sidebar-top-group mb-4">
                                    <SearchWidget />
                                    <RecentPostsWidget isFlexChild={true} blogs={allBlogs} />
                                </div>
                                <CategoryWidget />
                                <GalleryWidget />
                                <ArchiveWidget />
