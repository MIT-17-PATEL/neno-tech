...
const HeaderV4 = ({ lightMode, isOpen, openMenu, closeMenu, isMenuSticky }: DataType) => {
    return (
        <>
            <header>
                <nav className={`navbar mobile-sidenav navbar-sticky navbar-default validnavs white navbar-fixed on  ${isMenuSticky ? "sticked" : "no-background"} ${isOpen ? "navbar-responsive" : ""}`}>
