...
export const hireEngineersRoles: HireEngineerRole[] = [
  ...
  },
  {
    ...
    capabilities: [
      ...
      'Tool calling and structured output extraction',
      'RAG architectures and hybrid vector retrieval',
      'Guardrails, deterministic fallbacks, and security',
      'Continuous evaluation and latency tuning',
    ],
    technologies: ['LangChain', 'LlamaIndex', 'CrewAI / AutoGen', 'Python / FastAPI', 'OpenAI / Claude APIs', 'Pinecone / Qdrant / pgvector'],
    useCases: [
      'Autonomous workflow automation',
      'Intelligent customer service and research agents',
  ...
  },
  {
    ...
    description: 'Specialists in Anthropic Claude and the wider LLM stack: prompt architecture, context engineering, MCP integrations, fine-tuning, and cost/latency tuning.',
    overview: 'Engineers specialized in the Anthropic Claude ecosystem, Model Context Protocol (MCP), prompt engineering, context window management, token optimization, and LLM benchmarking.',
    capabilities: [
      'Model Context Protocol (MCP) tool integration',
      'Long-context architecture and caching strategies',
      'Advanced prompt engineering and system prompts',
      'Synthetic dataset curation and LoRA fine-tuning',
      'Latency reduction and cost optimization',
    ],
    ...
    useCases: [
      'Enterprise MCP tools and server development',
  ...
  },
  {
    ...
    description: 'Owns a product surface end to end: discovery, architecture, build, and release. For teams that need a builder, not just a coder.',
    ...
    useCases: [
      ...
      'Core product expansion and major feature delivery',
  ...
  },
  {
    ...
    capabilities: [
      'AI and LLM vulnerability assessments (prompt injection, jailbreaks)',
    ...
    useCases: [
      ...
      'Pre-launch security audits and hardening',
      'SOC 2 and enterprise compliance preparation',
  ...
  },
  {
    ...
    capabilities: [
      ...
      'Kubernetes orchestration and serverless setups',
    ...
    useCases: [
      'Enterprise design systems and frontend rebuilds',
      'Cloud migration and Kubernetes setup',
  ...
  },
  {
    ...
    description: 'Keep your existing applications running: monitoring, bug fixes, upgrades, and a documented SLA, including legacy systems your in-house team prefers not to maintain.',
    ...
    capabilities: [
      ...
      'Legacy codebase maintenance and patching',
      'Database health, backup, and DR management',
...
export const nenoServices: NenoServiceItem[] = [
  {
    ...
    capabilities: [
      'Multi-step agent planning and workflow routing',
      'Deterministic fallback mechanisms and guardrails',
    ...
    deliverables: [
      ...
      'Deployment pipelines and monitoring dashboard',
      'Complete architecture and operation docs',
    ],
  ...
  },
  {
    ...
    description: 'Take an AI product from idea to launch: discovery, architecture, build, deploy, and iterate with one accountable team.',
    ...
    capabilities: [
      ...
      'Product discovery and UX design for AI interfaces',
      'Scalable backend and real-time streaming architectures',
      'Model selection, evaluation, and latency optimization',
      'Automated deployment and post-launch scaling',
    ],
    deliverables: [
      ...
      'Source code repository and IP handover',
    ],
  ...
  },
  {
    ...
    description: 'An AI-native delivery squad that builds at high speed. Engineers working with Claude and modern AI tooling as a core workflow, with senior review so speed never compromises code quality.',
    overview: 'Rapid AI-assisted software delivery squads. Our engineers use modern AI programming tools combined with disciplined senior code review and architectural validation to ship significantly faster.',
    typicalBuild: '2-6 weeks',
    capabilities: [
      'Fast prototyping and MVP delivery',
      'AI-assisted rapid full-stack development',
      'Senior peer review and architectural guardrails',
      'Rapid feature iteration and user testing',
      'Clean code standards and comprehensive test suites',
    ],
    deliverables: [
  ...
  },
  {
    ...
    shortTitle: 'AI GTM',
    description: 'AI applied to how you sell: lead qualification agents, outbound systems, CRM intelligence, voice agents for follow-up, and pipeline analytics built into your sales stack.',
    overview: 'Upgrade your sales motion with AI systems engineered to automate prospecting, prospect research, personalized outreach, conversational inbound qualification, and real-time CRM updates.',
    typicalBuild: '3-8 weeks',
    capabilities: [
      'Automated prospect research and enrichment pipelines',
      'Dynamic, personalized multi-channel outreach engines',
      'Inbound lead qualification and meeting scheduling bots',
      'Voice AI agents for instant phone follow-up',
      'CRM synchronization and automated pipeline hygiene',
    ],
    deliverables: [
      'Configured AI lead research pipeline',
      'Custom inbound and outbound messaging agents',
      'CRM integration (HubSpot, Salesforce, Neno CRM)',
      'Voice AI calling workflows and scripts',
  ...
  },
  {
    ...
    description: 'When prompting is not enough: dataset preparation, fine-tuning, evaluation, and secure deployment, including private and on-premise setups for regulated data.',
    ...
    capabilities: [
      'Proprietary dataset curation and synthetic data generation',
      'Parameter-efficient fine-tuning (LoRA, QLoRA, Full)',
      'Domain-specific evaluation benchmarks and automated scoring',
      'Quantization and inference acceleration (vLLM, TensorRT-LLM)',
  ...
  },
  {
    ...
    description: 'Keep what works, fix what does not, and bring AI to the rest: support for existing applications, legacy modernization, and AI capability retrofitted into systems you already run.',
    ...
    capabilities: [
      'Legacy codebase refactoring and cloud migration',
      'AI feature retrofitting into existing enterprise software',
      '24/7 proactive monitoring and incident resolution',
      'API modernizations and microservice extraction',
      'SLA-backed tier-2 and tier-3 maintenance',
    ],
    deliverables: [
      'Legacy architecture audit and modernization roadmap',
...
export const serviceCategories: ServiceCategory[] = [
  {
    ...
    description: 'Pre-vetted senior engineering talent integrated into your team within 48 to 72 hours.',
    ...
    benefits: [
      ...
      'Direct integration with existing teams and workflows',
    ...
    children: [
      {
        ...
        capabilities: ['Customer-facing debugging and integration', 'Production pipeline stabilization', 'Custom client integrations and APIs', 'Rapid turnaround for edge-case bugfixes'],
        useCases: ['Enterprise AI rollout and customer onboarding', 'Mission-critical production deployments', 'Complex multi-tenant software integrations'],
      ...
      },
      {
        slug: 'claude-llm-engineer',
        title: 'Claude & LLM Engineer',
        description: 'Specialists in Anthropic Claude and the wider LLM stack: prompt architecture, context engineering, and MCP.',
        ...
        capabilities: ['Model Context Protocol (MCP) tool integration', 'Long-context architecture and caching strategies', 'Synthetic dataset curation and LoRA fine-tuning'],
        useCases: ['Enterprise MCP tools and server development', 'High-accuracy legal, financial, and code reasoning', 'Custom fine-tuned domain models'],
      ...
      },
      {
        ...
        capabilities: ['End-to-end web and mobile applications', 'RESTful and GraphQL API design', 'Database schema modeling and optimization'],
      ...
      },
      {
        slug: 'software-product-developer',
        title: 'Software Product Developer',
        description: 'Owns a product surface end to end: discovery, architecture, build, and release.',
        ...
        capabilities: ['Product discovery and technical scoping', 'Rapid prototyping and iterative shipping', 'Feature ownership from concept to release'],
        useCases: ['0 to 1 MVP development', 'Core product expansion and major feature delivery', 'Customer-facing product revitalization'],
      ...
      },
      {
        ...
        capabilities: ['AI and LLM vulnerability assessments', 'Application security and penetration testing', 'Cloud security posture management (CSPM)'],
        useCases: ['AI application threat modeling', 'Pre-launch security audits and hardening', 'SOC 2 and enterprise compliance preparation'],
      ...
      },
      {
        ...
        capabilities: ['Design system architecture and implementation', 'Accessible frontend UI development', 'Infrastructure as Code (IaC) with Terraform'],
        useCases: ['Enterprise design systems and frontend rebuilds', 'Cloud migration and Kubernetes setup', 'Performance optimization'],
      ...
      },
      {
        ...
        capabilities: ['L1, L2, and L3 tier production support', '24/7 uptime monitoring and incident response', 'Legacy codebase maintenance and patching'],
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        overview: 'Voice AI products that enable natural language interaction: intelligent call routing, voice assistants, transcription, and real-time translation.',
  ...
  },
  {
    ...
    overview: 'Expert guidance to help you make sound technology decisions, from AI strategy through product scaling and marketing infrastructure.',
    capabilities: [
    ...
    children: [
      {
        ...
        overview: 'We help organizations understand where AI creates genuine value, build a practical adoption roadmap, and avoid common technical pitfalls.',
...
export const caseStudies: CaseStudy[] = [
  {
    ...
    challenge: 'Manual CRM processes were creating bottlenecks in lead management, proposal follow-ups, and customer communication, resulting in missed opportunities and delayed responses.',
  ...
  },
  {
    ...
    customer: 'Enterprise Operations',
  ...
  },
  {
    ...
    challenge: 'Providing structured, personalized Ayurvedic wellness guidance at scale through interactive AI.',
    approach: 'We developed a specialized conversational AI trained on Ayurvedic principles, capable of providing structured health recommendations based on individual profiles.',
...
export const teamMembers: TeamMember[] = [
  {
    name: 'Tirth Patel',
    role: 'Co-founder',
    bio: 'Strategist leading business development and strategic partnerships at Neno Technology.',
