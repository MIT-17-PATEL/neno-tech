...
const INITIAL_CASE_STUDIES: CaseStudy[] = [
  ...
  },
  {
    ...
    implementation: 'Deployed containerized TensorRT models directly on edge gateway nodes. Processed high-frequency acoustic and vibration streams in real-time, dispatching automatic work orders to SAP PM upon anomaly detection.',
    results: 'Slashing unplanned equipment downtime by 82% and delivering $2.6M in net annual maintenance savings with 72-hour advance anomaly warnings.',
    metric1Value: '82%',
    metric1Label: 'Downtime Reduced',
    metric2Value: '72 Hours',
    metric2Label: 'Anomaly Warning Lead',
    metric3Value: '$2.6M',
    metric3Label: 'Annual Cost Savings',
