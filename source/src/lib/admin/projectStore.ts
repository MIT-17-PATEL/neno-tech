...
const INITIAL_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    fullDescription: 'Architected low-latency full-duplex speech AI agents with dynamic interruption handling, caller intent classification, and real-time knowledge base retrieval for enterprise support operations.',
    image: '/assets/img/projects/project-ai-1.jpg',
    metric1Value: '<200ms',
    metric1Label: 'Voice Latency',
    metric2Value: '74%',
    metric2Label: 'First-Contact Resolution',
    metric3Value: '$3.2M',
    metric3Label: 'Annual Support Savings',
    tags: ['Voice AI', 'SIP / WebRTC', 'Autonomous Agents', 'Speech-to-Speech'],
    relatedCaseStudy: 'Autonomous Voice AI Agents for Real-Time FinTech Underwriting',
    status: 'Published',
  ...
  },
  {
    ...
    fullDescription: 'Designed and deployed an ultra-low latency risk assessment engine leveraging vectorized transaction embeddings, anomaly detection models, and automated compliance alert generation.',
    image: '/assets/img/projects/project-ai-2.jpg',
    metric1Value: '45k tx/s',
    metric1Label: 'Throughput Capacity',
    metric2Value: '99.98%',
    metric2Label: 'Detection Precision',
    metric3Value: '<12ms',
    metric3Label: 'Decision Latency',
    tags: ['Fraud Detection', 'FinTech', 'Real-Time ML', 'Graph Neural Nets'],
    relatedCaseStudy: 'Autonomous Voice AI Agents for Real-Time FinTech Underwriting',
    status: 'Published',
